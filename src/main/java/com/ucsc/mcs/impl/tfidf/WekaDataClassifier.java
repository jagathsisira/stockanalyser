 ...
 */
public class WekaDataClassifier {
    private static final Logger logger = Logger.getLogger(SvmClassifierTfIdf.class);

    private static final WekaDataClassifier wekaClassifier = new WekaDataClassifier();
    ...
    private WekaDataClassifier() {
    }

    public static WekaDataClassifier getInstance() {
