...
public class CrossValidationClassifier {
    ...
    private static final CrossValidationClassifier crossValidationClassifier = new CrossValidationClassifier();
    ...
    private CrossValidationClassifier() {
        predict(null);
    }

  public static void main(String[] args) {
    new CrossValidationClassifier();
  }

    public static CrossValidationClassifier getInstance() {
        return crossValidationClassifier;
    }
