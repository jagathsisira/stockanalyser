...
public class KNearestNeighbourClassifier {
    private static final Logger logger = Logger.getLogger(KNearestNeighbourClassifier.class);

    private static final KNearestNeighbourClassifier kNearestNeighbourClassifier = new KNearestNeighbourClassifier();
    ...
    private KNearestNeighbourClassifier() {
    }

    public static KNearestNeighbourClassifier getInstance() {
...
//                    }
                    ...
                    stringBuilder.append(originalWeight);
...
//                    System.out.println("++++ " + stringBuilder.toString());
                        ...
                        "./src/main/resources/tmpNewsTfIds.data"),0,",");
//            Dataset dataForClassification = FileHandler.loadDataset(new File("./src/main/resources/svmTfIdf.data"), 0, ",");
